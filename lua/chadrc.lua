...
M.nvdash = {
  ...
  buttons = {
    ...
    },
    {
      multicolumn = true,
      { txt = "󰈞  ", hl = "Function" },
      { txt = "Find File", hl = "NvdashButtons" },
      keys = "Ff",
    ...
    },
    {
      multicolumn = true,
      { txt = "󰈚  ", hl = "String" },
      { txt = "Recent Files", hl = "NvdashButtons" },
      keys = "Fo",
    ...
    },
    {
      multicolumn = true,
      { txt = "󰈭  ", hl = "Type" },
      { txt = "Find Word", hl = "NvdashButtons" },
      keys = "Fw",
    ...
    },
    {
      multicolumn = true,
      { txt = "󱔗  ", hl = "Identifier" },
      { txt = "Pick Toolchain", hl = "NvdashButtons" },
      keys = "Lp",
      cmd = "LspPick",
    },
    {
      multicolumn = true,
      { txt = "󱗆  ", hl = "Keyword" },
      { txt = "Respect NvChad", hl = "NvdashButtons" },
      keys = "Nv",
    ...
    },
    {
      ...
      { txt = "Check Health", hl = "NvdashButtons" },
      keys = "Ch",
      cmd = "checkhealth",
    },
    {
      multicolumn = true,
      { txt = "󰒲  ", hl = "Special" },
      { txt = "Lazy Status", hl = "NvdashButtons" },
      keys = "Ls",
      cmd = "Lazy",
    },
  },
